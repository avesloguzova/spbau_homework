...
public class Compressor implements Closeable {
     ...
     */
    public Compressor(String outputFileName) throws IOException {
    ...
    public void compressFile(File file) throws IOException {
        if (file.isFile()) {
            ...
            this.outputStream.writeUTF(file.getPath());
     ...
     * @throws IOException                  if an I/O error occurs during writing to archive
     */
    public void compressWebPage(URL url) throws IOException {
        byte[] contents;
